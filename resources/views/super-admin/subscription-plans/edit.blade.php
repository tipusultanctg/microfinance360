        ...
        <div class="col-md-8 grid-margin stretch-card">
            <div class="card">
                <div class="card-body">
                    ...
                    <form class="forms-sample" method="POST" action="{{ route('super-admin.subscription-plans.update', $subscriptionPlan->id) }}">
                        @csrf
                        @method('PUT')
                        <div class="mb-3">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="number" class="form-control @error('member_limit') is-invalid @enderror" id="member_limit" name="member_limit" value="{{ old('member_limit', $subscriptionPlan->member_limit) }}">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="number" class="form-control @error('loan_limit') is-invalid @enderror" id="loan_limit" name="loan_limit" value="{{ old('loan_limit', $subscriptionPlan->loan_limit) }}">
                            <small class="form-text text-muted">Leave blank for unlimited loans.</small>
                        </div>
                        <div class="mb-3">
                            <label for="features" class="form-label">Features</label>
                            <textarea class="form-control" id="features" name="features" rows="5">{{ old('features', is_array($subscriptionPlan->features) ? implode("\n", $subscriptionPlan->features) : '') }}</textarea>
